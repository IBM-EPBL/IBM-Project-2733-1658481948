...
def index():
    if request.method == 'POST':
        ...
        API_KEY = "dGIxSW08kkFMfQYJQUrNhrU9VA3OHtAczqSBGZzLxtcw"
        ...
        response_scoring = requests.post(
            'https://us-south.ml.cloud.ibm.com/ml/v4/deployments/9834b7d9-ae44-4b96-a013-385bc8cfaddf/predictions?version=2022-11-16', 
